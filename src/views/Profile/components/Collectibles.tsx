  ...
  return (
    <>
      <Heading as="h4" scale="md" mb="8px">
        {t('NitfeeDex Collectibles')}
      </Heading>
      <Text as="p">
        {t('NitfeeDex Collectibles are special ERC-721 NFTs that can be used on the NitfeeDex platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved NitfeeDex Collectibles won’t be shown here.')}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/collectibles">{t('See all approved NitfeeDex Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
