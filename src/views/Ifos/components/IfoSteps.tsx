    ...
    switch (step) {
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active NitfeeDex Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
      ...
      case 1:
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              {t('Get NTFD-CFX LP Tokens')}
            </Heading>
            <Text color="textSubtle" small>
              {t('Stake NTFD and CFX in the liquidity pool to get LP tokens.')} <br />
              {t('You’ll spend them to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href={`${BASE_ADD_LIQUIDITY_URL}/CFX/0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9`}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent NTFD-CFX LP tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
