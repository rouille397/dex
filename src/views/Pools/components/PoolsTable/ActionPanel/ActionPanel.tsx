  ...
  const blocksRow =
    blocksRemaining || blocksUntilStart ? (
      <Flex mb="8px" justifyContent="space-between">
        ...
        <Flex>
          <Link external href={getConfluxScanLink(hasPoolStarted ? endBlock : startBlock, 'countdown')}>
      ...
      <ActionContainer>
        {showSubtitle && (
          <Text mt="4px" mb="16px" color="textSubtle">
            {isAutoVault ? t('Automatic restaking') : `${t('Earn')} NTFD ${t('Stake').toLocaleLowerCase()} NTFD`}
          </Text>
        )}
